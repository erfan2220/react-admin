...
interface BarChartMaterialCellsProps {
    dataPerProvince: {
        cells_count: {
            vendor: string;
            type: string;
...
const RoundedBar_2: React.FC<any> = (props) => {
...
const BarChartMaterialCells: React.FC<BarChartMaterialCellsProps> = ({ dataPerProvince }) => {
    const filter_counters_2 = (vendor: string, type: string) => {
        const filteredItems = dataPerProvince.cells_count.filter(item => item.vendor === vendor && item.type === type);
                ...
                <div className="test_barchart_container_2">
                    <ResponsiveContainer width="80%" height="100%">
                        ...
                        >
                            ...
                            <Tooltip cursor={false} content={<CustomTooltip data={dataPerProvince} />} />
                            <Bar dataKey="uv2" fill="#007BFF" shape={<RoundedBar_2 radius={4} />} />
                            <Bar dataKey="pv2" fill="#18D3CC" shape={<RoundedBar_2 radius={4} />} />
                            <Bar dataKey="cv2" fill="#99CAFF" shape={<RoundedBar_2 radius={4} />} />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
